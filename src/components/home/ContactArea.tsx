            ...
            <div className="col-lg-4">
              <div className="contact-content-part  wow fadeInUp delay-0-2s">
                ...
                {/* <div className="single-contact wow fadeInUp" data-wow-delay=".2s">
                  ...
                  <h2>Address:</h2>
                  <p>Barauli, Gopalganj, Bihar-841405</p>
                </div> */}
                ...
                <div className="single-contact wow fadeInUp" data-wow-delay=".6s">
                  ...
                  <div className="about-social">
                    <ul>
                      <li><a target='_blank' href="https://www.facebook.com/share/15yPmpW9g7/"><i className="ri-facebook-circle-fill"></i></a></li>
                      <li><a target='_blank' href="https://x.com/pankajs55247126"><i className="ri-twitter-x-line"></i></a></li>
                      <li><a target='_blank' href="https://www.linkedin.com/in/pankaj-singh-612934230/"><i className="ri-linkedin-fill"></i></a></li>
                      <li><a target='_blank' href="https://github.com/pankajfullstackdeveloper"><i className="ri-github-line"></i></a></li>
                    </ul>
                  </div>
                </div>
